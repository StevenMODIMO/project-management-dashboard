  ...
  return (
    <main className="flex">
      ...
      <form
        ...
        className="w-fit h-fit mx-auto mt-[7%] flex flex-col gap-3 p-4 border border-[#adf367] rounded-md"
      >
        ...
        <input
          id="email"
          className="outline-none border border-[#adf367] p-2 w-96 rounded-md text-gray-500"
          value={email}
        ...
        <section>
          <header className="text-gray-500 cursor-pointer">
            ...
            <div className="flex gap-3 mt-2">
              <FcGoogle className="text-4xl shadow p-2 rounded-md" />
              <FaGithub className="text-4xl shadow p-2 rounded-md" />
              <FaXTwitter className="text-4xl shadow p-2 rounded-md" />
            </div>
          </header>
        </section>
      </form>
